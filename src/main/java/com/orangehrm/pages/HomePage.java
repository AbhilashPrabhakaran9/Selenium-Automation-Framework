...
public class HomePage {
	...
	//I can also use place holder instead of text
	...
	//Method to verify if orangeHRM Logo is displaying
	public boolean verifyOrangeHRMlogo() {
		return actionDriver.isDisplayed(orangeHRMlogo);
	}
	
	//Action related methods
	//Method to navigate to PIM tab [Clicking PIM tab]
	...
	//We can call the below 2 verification methods using Test class.
